...
Note that the store is runtime state: non-serializable handles such as auth tokens or database connections will not survive `saveRDS()`. Use `clone(deep = TRUE)` if you need a chat copy with its own independent store.
