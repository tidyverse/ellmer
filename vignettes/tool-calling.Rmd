...
**Async tools:** in an async tool, `tool_context()` is only valid during the
synchronous prefix of the function — before the first `await()`. Capture it at
the top of your tool body:
