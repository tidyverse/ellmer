...
* `allowed_callers` must match the `type` of the registered
  `claude_tool_code_execution()` tool (`"code_execution_20250825"` by default;
  see `?claude_tool_code_execution` for choosing a version).
