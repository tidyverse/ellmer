...
* New `chat_azure_anthropic()` enables chatting with Anthropic Claude models
  hosted on Azure AI Foundry (`*.services.ai.azure.com/anthropic` endpoints),
  with the same Azure authentication options as `chat_azure_openai()` (#585).
