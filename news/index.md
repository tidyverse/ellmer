...
- [`tool()`](https://ellmer.tidyverse.org/reference/tool.md) functions
  that return complex objects like data frames or lists now produce a
  deprecation warning. Tool functions should return a character vector,
  an atomic vector, a JSON string (from
...
- [`claude_tool_web_search()`](https://ellmer.tidyverse.org/reference/claude_tool_web_search.md),
  ...
  [`google_tool_web_search()`](https://ellmer.tidyverse.org/reference/google_tool_web_search.md),
  and
  [`openai_tool_web_search()`](https://ellmer.tidyverse.org/reference/openai_tool_web_search.md)
...
- New
  ...
  model, and
  [`content_pdf_url()`](https://ellmer.tidyverse.org/reference/content_pdf_file.md)
...
- [`batch_chat()`](https://ellmer.tidyverse.org/reference/batch_chat.md)
  now supports
  [`chat_google_gemini()`](https://ellmer.tidyverse.org/reference/chat_google_gemini.md)
  and
...
- [`chat()`](https://ellmer.tidyverse.org/reference/chat-any.md) now
...
- [`chat_google_vertex()`](https://ellmer.tidyverse.org/reference/chat_google_gemini.md)
  and
  [`models_google_vertex()`](https://ellmer.tidyverse.org/reference/chat_google_gemini.md)
...
- New
  [`chat_posit()`](https://ellmer.tidyverse.org/reference/chat_posit.md)
  and
  [`models_posit()`](https://ellmer.tidyverse.org/reference/chat_posit.md)
...
- [`models_deepseek()`](https://ellmer.tidyverse.org/reference/chat_deepseek.md)
...
- [`models_groq()`](https://ellmer.tidyverse.org/reference/chat_groq.md)
  lists available models for
  [`chat_groq()`](https://ellmer.tidyverse.org/reference/chat_groq.md)
  ([@thisisnic](https://github.com/thisisnic),
...
- [`claude_tool_web_search()`](https://ellmer.tidyverse.org/reference/claude_tool_web_search.md),
  ...
  created by [`tool()`](https://ellmer.tidyverse.org/reference/tool.md)
...
- [`chat_anthropic()`](https://ellmer.tidyverse.org/reference/chat_anthropic.md)
  ...
  [`token_usage()`](https://ellmer.tidyverse.org/reference/token_usage.md)
  and
  [`parallel_chat()`](https://ellmer.tidyverse.org/reference/parallel_chat.md)
...
- [`models_anthropic()`](https://ellmer.tidyverse.org/reference/chat_anthropic.md)
  (and
  [`models_claude()`](https://ellmer.tidyverse.org/reference/chat_anthropic.md))
...
- [`chat_claude()`](https://ellmer.tidyverse.org/reference/chat_anthropic.md)
...
- ellmer now supports a variety of built-in web search and fetch tools
  ...
  - [`google_tool_web_search()`](https://ellmer.tidyverse.org/reference/google_tool_web_search.md)
    and
    [`google_tool_web_fetch()`](https://ellmer.tidyverse.org/reference/google_tool_web_fetch.md)
    for Gemini.
  - [`openai_tool_web_search()`](https://ellmer.tidyverse.org/reference/openai_tool_web_search.md)
...
- [`tool()`](https://ellmer.tidyverse.org/reference/tool.md)s can now
  return image or PDF content types, with
...
- [`params()`](https://ellmer.tidyverse.org/reference/params.md) gains
  new `reasoning_effort` and `reasoning_tokens` so you can control the
  amount of effort a model spends on thinking. Initial support is
  provided for
  [`chat_claude()`](https://ellmer.tidyverse.org/reference/chat_anthropic.md),
  [`chat_google_gemini()`](https://ellmer.tidyverse.org/reference/chat_google_gemini.md),
  and
...
- New
  [`type_ignore()`](https://ellmer.tidyverse.org/reference/type_boolean.md)
...
- `batch_chat_*()` and `parallel_chat_*()` now accept a string as the
  ...
  [`chat()`](https://ellmer.tidyverse.org/reference/chat-any.md)
...
- [`models_ollama()`](https://ellmer.tidyverse.org/reference/chat_ollama.md)
...
- [`chat()`](https://ellmer.tidyverse.org/reference/chat-any.md) is now
  compatible with most `chat_` functions
  ...
  - [`chat_aws_bedrock()`](https://ellmer.tidyverse.org/reference/chat_aws_bedrock.md),
    ...
    [`chat_perplexity()`](https://ellmer.tidyverse.org/reference/chat_perplexity.md),
    and
    [`chat_vllm()`](https://ellmer.tidyverse.org/reference/chat_vllm.md)
    now support a `params` argument that accepts common model parameters
    from [`params()`](https://ellmer.tidyverse.org/reference/params.md).
...
- [`chat_openai()`](https://ellmer.tidyverse.org/reference/chat_openai.md)
  ...
  [`params()`](https://ellmer.tidyverse.org/reference/params.md) to the
...
- [`contents_record()`](https://ellmer.tidyverse.org/reference/contents_record.md)
  and
  [`contents_replay()`](https://ellmer.tidyverse.org/reference/contents_record.md)
...
- New [`chat()`](https://ellmer.tidyverse.org/reference/chat-any.md)
...
- [`tool()`](https://ellmer.tidyverse.org/reference/tool.md) has a
  ...
  convert, [`?tool`](https://ellmer.tidyverse.org/reference/tool.md)
...
- New
  [`parallel_chat_text()`](https://ellmer.tidyverse.org/reference/parallel_chat.md)
  and
  [`batch_chat_text()`](https://ellmer.tidyverse.org/reference/batch_chat.md)
...
- [`batch_chat_structured()`](https://ellmer.tidyverse.org/reference/batch_chat.md)
...
- [`tool()`](https://ellmer.tidyverse.org/reference/tool.md) checks that
  the `name` is valid
...
- [`type_from_schema()`](https://ellmer.tidyverse.org/reference/type_boolean.md)
...
- We have made a number of refinements to the way ellmer converts JSON
  ...
  [`tool()`](https://ellmer.tidyverse.org/reference/tool.md).
...
- [`models_google_gemini()`](https://ellmer.tidyverse.org/reference/chat_google_gemini.md),
  [`models_anthropic()`](https://ellmer.tidyverse.org/reference/chat_anthropic.md),
  [`models_openai()`](https://ellmer.tidyverse.org/reference/chat_openai.md),
  [`models_aws_bedrock()`](https://ellmer.tidyverse.org/reference/chat_aws_bedrock.md),
  [`models_ollama()`](https://ellmer.tidyverse.org/reference/chat_ollama.md)
  and
  [`models_vllm()`](https://ellmer.tidyverse.org/reference/chat_vllm.md),
...
- [`interpolate()`](https://ellmer.tidyverse.org/reference/interpolate.md)
...
- [`chat_anthropic()`](https://ellmer.tidyverse.org/reference/chat_anthropic.md),
  ...
  the [`params()`](https://ellmer.tidyverse.org/reference/params.md)
...
- We have support for three new providers:
  ...
  - [`chat_portkey()`](https://ellmer.tidyverse.org/reference/chat_portkey.md)
    and
    [`models_portkey()`](https://ellmer.tidyverse.org/reference/chat_portkey.md)
...
- `ContentToolResult` objects can now be returned directly from the
  [`tool()`](https://ellmer.tidyverse.org/reference/tool.md) function
...
- `ContentToolRequest` gains a `tool` property that includes the
  [`tool()`](https://ellmer.tidyverse.org/reference/tool.md) definition
  when a request is matched to a tool by ellmer
  ([\#423](https://github.com/tidyverse/ellmer/issues/423),
  [@gadenbuie](https://github.com/gadenbuie)).

- [`tool()`](https://ellmer.tidyverse.org/reference/tool.md) gains an
  `.annotations` argument that can be created with the
...
- [`chat_ollama()`](https://ellmer.tidyverse.org/reference/chat_ollama.md)
  now works with
  [`tool()`](https://ellmer.tidyverse.org/reference/tool.md) definitions
  with optional arguments or empty properties
...
- [`content_pdf_file()`](https://ellmer.tidyverse.org/reference/content_pdf_file.md)
  and
  [`content_pdf_url()`](https://ellmer.tidyverse.org/reference/content_pdf_file.md)
...
- The general `ToolArg()` has been replaced by the more specific
  `type_*()` functions.
  [`ToolDef()`](https://ellmer.tidyverse.org/reference/ToolDef.md) has
...
- `chat_browser()` and `chat_console()` are now
  [`live_browser()`](https://ellmer.tidyverse.org/reference/live_console.md)
  and
  [`live_console()`](https://ellmer.tidyverse.org/reference/live_console.md).
