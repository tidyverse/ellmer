...
- [`anthropic_file_upload()`](https://ellmer.tidyverse.org/dev/reference/anthropic_file_upload.md)
  [`anthropic_file_list()`](https://ellmer.tidyverse.org/dev/reference/anthropic_file_upload.md)
  [`anthropic_file_get()`](https://ellmer.tidyverse.org/dev/reference/anthropic_file_upload.md)
  [`anthropic_file_download()`](https://ellmer.tidyverse.org/dev/reference/anthropic_file_upload.md)
  [`anthropic_file_delete()`](https://ellmer.tidyverse.org/dev/reference/anthropic_file_upload.md)
