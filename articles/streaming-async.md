...
The [`chat()`](https://ellmer.tidyverse.org/reference/chat-any.md)
...
[`chat()`](https://ellmer.tidyverse.org/reference/chat-any.md)/`stream()`.
...
[`chat()`](https://ellmer.tidyverse.org/reference/chat-any.md) method as
