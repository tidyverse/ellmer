test_that("can make simple batch request", {
  vcr_local_cassette("anthropic-batch")
...
test_that("can list models", {
  vcr_local_cassette("anthropic-list-models")
...
test_that("supports standard parameters", {
  vcr_local_cassette("anthropic-standard-params")
...
test_that("supports tool calling", {
  vcr_local_cassette("anthropic-tool")
  chat_fun <- chat_anthropic_test
...
test_that("can extract data", {
  vcr_local_cassette("anthropic-structured-data")
  chat_fun <- chat_anthropic_test
...
test_that("can use images", {
  vcr_local_cassette("anthropic-images")
  chat_fun <- chat_anthropic_test
...
test_that("can use pdfs", {
  vcr_local_cassette("anthropic-pdfs")
  chat_fun <- chat_anthropic_test
...
test_that("continues to work after whitespace only outputs (#376)", {
  vcr_local_cassette("anthropic-whitespace")
