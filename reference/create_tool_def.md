...
right call to
[`tool()`](https://ellmer.tidyverse.org/reference/tool.md). This
...
[`tool()`](https://ellmer.tidyverse.org/reference/tool.md) call. It's
meant to be used interactively while writing your code, not as part of
your final code.
