...
- [`chat()`](https://ellmer.tidyverse.org/reference/chat-any.md) : Chat
  with any provider
...
- [`batch_chat()`](https://ellmer.tidyverse.org/reference/batch_chat.md)
  ...
  [`batch_chat_completed()`](https://ellmer.tidyverse.org/reference/batch_chat.md)
...
- [`tool()`](https://ellmer.tidyverse.org/reference/tool.md) : Define a
  tool
...
- [`TypeBasic()`](https://ellmer.tidyverse.org/reference/Type.md)
  ...
  [`TypeJsonSchema()`](https://ellmer.tidyverse.org/reference/Type.md)
...
- [`contents_text()`](https://ellmer.tidyverse.org/reference/contents_text.md)
  [`contents_html()`](https://ellmer.tidyverse.org/reference/contents_text.md)
  [`contents_markdown()`](https://ellmer.tidyverse.org/reference/contents_text.md)
...
- [`df_schema()`](https://ellmer.tidyverse.org/reference/df_schema.md) :
