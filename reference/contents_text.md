...
[Turn](https://ellmer.tidyverse.org/reference/Turn.md) contents or
...
- content:
  ...
  The [Turn](https://ellmer.tidyverse.org/reference/Turn.md),
  [Round](https://ellmer.tidyverse.org/reference/Round.md), or
  [Content](https://ellmer.tidyverse.org/reference/Content.md) object to
  be converted into text. `contents_markdown()` also accepts
  [Chat](https://ellmer.tidyverse.org/reference/Chat.md) instances to
  turn the entire conversation history into markdown text.
