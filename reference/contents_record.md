...
- `contents_replay()` takes the output of `contents_record()` and
  returns a [Turn](https://ellmer.tidyverse.org/reference/Turn.md) or
  [Content](https://ellmer.tidyverse.org/reference/Content.md) object.
...
- x:
  ...
  A [Turn](https://ellmer.tidyverse.org/reference/Turn.md) or
  [Content](https://ellmer.tidyverse.org/reference/Content.md) object to
  serialize; or a serialized object to replay.
...
- .envir:
  ...
  [Turn](https://ellmer.tidyverse.org/reference/Turn.md) or
  [Content](https://ellmer.tidyverse.org/reference/Content.md) but are
  not from the ellmer package itself.
