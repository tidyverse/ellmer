...
If you have a ChatGPT Plus/Pro subscription, the experimental `chat_openai_codex_responses()` provider can use ChatGPT Codex subscription authentication instead of an OpenAI API key. This is separate from `chat_openai()`, which uses the OpenAI developer API.
