...
#'   setting](https://developers.openai.com/api/docs/guides/images/image-input-requirements)
...
#'   docs](https://developers.openai.com/api/docs/guides/images/image-input-requirements)
...
content_image_file <- function(path, content_type = "auto", resize = "low") {
  ...
  if (content_type == "auto") {
    ...
    # https://developers.openai.com/api/docs/guides/images/image-input-requirements
