...
#'
#' @param context An `ellmer_tool_context` object. Fabricate one in tests as
#'   `structure(list(request = ..., store = ..., turns = ...), class =
#'   "ellmer_tool_context")`.
