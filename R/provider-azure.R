...
#' @param credentials `r api_key_param("AZURE_OPENAI_API_KEY")` This can also
#'   be a list of authentication headers to pass into [`httr2::req_headers()`], a
#'   function that returns them, or `NULL` to use `token` or `api_key` to generate
#'   these headers instead. This is an escape hatch that allows users to incorporate
#'   Azure credentials generated by other packages into \pkg{ellmer}, or to manage
#'   the lifetime of credentials that need to be refreshed.
