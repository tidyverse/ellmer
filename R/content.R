...
#'
#' Citations appear in a turn's contents list interleaved with [ContentText]
#' objects. Their position indicates which text they annotate. Use
#' `turn@citations` to retrieve all citations from a turn.
#'
